...
- **A milestone:** `Serverpod (Oct 14)` · `HackMeridian (Oct 25)` · `Bootcamp`

Each issue lists its **Deliverables**, **Acceptance criteria**, **How to verify**, **Out of scope**, and **Depends on**. Read all of them before starting.
